...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Add Liquidity`)} | Metidorians</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the Metidorians AMM to enable gas optimised and low slippage trade on Metis network"
        />
      </Head>
      <MetidoriansLogo />
      <Container id="remove-liquidity-page" maxWidth="2xl" className="space-y-4">
          ...
          <div className="p-4 space-y-4 rounded bg-dark-900/20" style={{ zIndex: 1 }}>
            ...
            <div className="flex flex-col space-y-4">
              ...
              {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
                <div className="p-1 rounded bg-dark-800/20">
                  <LiquidityPrice
                    currencies={currencies}
                    price={price}
                    noLiquidity={noLiquidity}
        ...
        <div className="flex items-center px-4">
          <NavLink href="/exchange/pool">
            <a className="flex items-center space-x-2 font-medium text-center cursor-pointer text-base text-green  hover:text-high-emphesis">
