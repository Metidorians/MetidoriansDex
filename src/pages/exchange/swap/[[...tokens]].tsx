...
export default function Swap() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Metidorians`)}</title>
        <meta
          key="description"
          name="description"
          content="Metidorians allows for swapping of compatible tokens on Moonriver."
        />
      </Head>
      ...
      <DoubleGlowShadow opacity="0.6">
        <div id="swap-page" className="w-full max-w-2xl p-4 space-y-4 rounded bg-dark-900/20 z-1">
          <SwapHeader
          ...
          <div>
            ...
            <AutoColumn justify="space-between" className="py-3">
              <AutoRow justify={isExpertMode ? 'space-between' : 'flex-start'} style={{ padding: '0 1rem' }}>
                ...
                >
                  <div className="rounded-full bg-dark-900/20 p-3px">
                    <div
                      className="p-3 rounded-full bg-dark-800/20 hover:bg-dark-700"
            ...
            <div>
              ...
              />
              {Boolean(trade) && (
                <div className="p-1 -mt-2 rounded-b-md bg-dark-800/20">
                  <TradePrice
