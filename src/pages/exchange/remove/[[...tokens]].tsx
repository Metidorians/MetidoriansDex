...
export default function Remove() {
  ...
  function modalBottom() {
    return (
      <div className="p-6 mt-0 -m-6 bg-dark-800/20">
        {pair && (
          <>
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Remove Liquidity`)} | Metidorians </title>
        <meta key="description" name="description" content={i18n._(t`Remove liquidity of Metidorians`)} />
      </Head>

      <Container id="remove-liquidity-page" maxWidth="2xl" className="space-y-4">
        <DoubleGlowShadow>
          <div className="p-4 space-y-4 rounded bg-dark-900/20" style={{ zIndex: 1 }}>          
                ...
                <div>
                  ...
                  <AutoColumn justify="space-between" className="py-2.5">
                    <AutoRow justify={'flex-start'} style={{ padding: '0 1rem' }}>
                      <button className="z-10 -mt-6 -mb-6 rounded-full cursor-default bg-dark-900/20 p-3px">
                        <div className="p-3 rounded-full bg-dark-800/20">
                  ...
                  <div id="remove-liquidity-output" className="p-5 rounded bg-white-800/20">
                    <div className="flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
                      ...
                      <div className="flex flex-col space-y-3 md:flex-row md:space-x-6 md:space-y-0">
                        <div className="flex flex-row items-center w-full p-3 pr-8 space-x-3 rounded bg-dark-900/20">
