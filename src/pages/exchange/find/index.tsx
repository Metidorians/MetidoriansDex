...
export default function PoolFinder() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Find Pool`)} | Metidorians</title>
            ...
            <AutoColumn gap={'md'}>
              ...
              <AutoColumn justify="space-between">
                <AutoRow justify={'flex-start'} style={{ padding: '0 1rem' }}>
                  <button className="z-10 -mt-6 -mb-6 rounded-full bg-dark-900/20 p-3px">
                    <div className="p-3 rounded-full bg-dark-800/20 hover:bg-dark-700">
                      <Plus size="32" />
                    </div>
                  </button>
                </AutoRow>
            ...
            {currency0 && currency1 ? (
              pairState === PairState.EXISTS ? (
                hasPosition && pair ? (
                  ...
                  <div className="p-5 rounded bg-dark-800/20">
                ...
                <div className="p-5 rounded bg-dark-800/20">
                  <AutoColumn gap="sm" justify="center">
                    ...
                    <Link href={`/exchange/add/${currencyId(currency0)}/${currencyId(currency1)}`}>
                      <a className="text-center text-blue">{i18n._(t`Create pool`)}</a>
                    </Link>
                  </AutoColumn>
                </div>
              ) : pairState === PairState.INVALID ? (
                <div className="p-5 text-center rounded bg-dark-800/20">{i18n._(t`Invalid pair`)}</div>
              ) : pairState === PairState.LOADING ? (
                <div className="p-5 text-center rounded bg-dark-800/20">
