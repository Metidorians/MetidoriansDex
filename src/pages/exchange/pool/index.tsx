...
export default function Pool() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Pool`)} | Metidorians</title>
        <meta
          key="description"
          name="description"
          content="Meridorians liquidity pools are markets for trades between the two tokens, you can provide these tokens and become a liquidity provider to earn 0.25% of fees from trades."
        />
      </Head>
      <MetidoriansLogo />
      <DoubleGlowShadow opacity="0.6">
        ...
        /> */}
          ...
          <div className="p-4 space-y-4 rounded bg-dark-900/20">
            ...
            <div className="grid grid-flow-row gap-3">
              ...
              {account && (
                <div className={classNames('grid gap-4', migrationSupported ? 'grid-cols-3' : 'grid-cols-2')}>
                  ...
                  <Button id="add-pool-button" color="metidorians" onClick={() => router.push(`/exchange/find`)}>
                    {i18n._(t`Import`)}
                  </Button>
