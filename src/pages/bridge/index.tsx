...
export default function Bridge() {
  ...
  return (
    <>
      ...
      <Head>
        <title>{i18n._(t`Bridge`)} | Metidorians</title>
        ...
        <DoubleGlowShadow opacity="0.6">
          <div className="p-4 space-y-4 rounded bg-dark-900/20" style={{ zIndex: 1 }}>
            <div className="flex items-center justify-center mb-4 space-x-3">
              <div className="grid grid-cols-3 rounded p-3px bg-dark-80020 h-[46px]">
                <NavLink
                  activeClassName="font-bold border rounded text-high-emphesis border-dark-700 bg-dark-700/20"
                  exact
                  href={{
                    pathname: '/bridge',
                  }}
            ...
            <div className="p-4 text-center">
              <div className="items-center justify-between space-x-3">
                <Typography component="h3" variant="base">
                  {i18n._(t`Bridge integration coming soon!`)}
                </Typography>
              </div>
            </div>
            ...
            <AutoRow
              ...
              gap={'0 3px'}
            >
              {i18n._(t`Stay tuned for bridge announcements`)}
            </AutoRow>
          </div>
        </DoubleGlowShadow>
      </Container>
