...
export default function Faucet(): JSX.Element {
  ...
  return (
    <>
      <Head>
        <title>Faucet | Metidorians</title>
            ...
            <div className="h-[570px] flex flex-col justify-center items-center">
              <div className="p-4 mb-3 space-y-3 text-center">
                <Typography component="h1" variant="base">
                  A Faucet is a tool that provides a small amount of METIS for users that used the bridge to start using
                  
                </Typography>
              </div>
              <div className="flex items-center justify-center flex-1 mt-8 mb-12 text-center">
                <Image src="/images/faucet/moonriver-faucet.png" alt="Metidorians" width={150} height={150} />
              </div>
