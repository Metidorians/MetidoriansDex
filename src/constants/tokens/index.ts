...
export const FANTOM: { [key: string]: Token } = {
  USDC: new Token(ChainId.FANTOM, '0xEA32A96608495e54156Ae48931A7c20f0dcc1a21', 6, 'USDC', 'USD Coin'),
...
export const METIS: { [key: string]: Token } = {
  USDC: new Token(ChainId.METIS, '0xEA32A96608495e54156Ae48931A7c20f0dcc1a21', 6, 'USDC', 'USD Coin'),
  WETH: new Token(ChainId.METIS, '0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000', 18, 'WETH', 'Wrapped Metis'),
  METIDORIANS: new Token(ChainId.METIS, '0x6957B8F72b9DcB6A05E1384E422454F107Ebe0a8', 18, 'MMDorians', 'Metidorians'),
}
...
export const MOONRIVER: { [key: string]: Token } = {
  ...
  SOLAR: new Token(ChainId.MOONRIVER, '0x544632a851963a9289DfbFfDF58125788Ae56A43', 18, 'MMDORIANS', 'Metidorians Token'),
...
export const METIDORIANS_ADDRESS = {
  [ChainId.MAINNET]: '',
  [ChainId.ROPSTEN]: '',
  [ChainId.RINKEBY]: '',
  [ChainId.GÖRLI]: '',
  ...
  [ChainId.MOONRIVER]: '0x544632a851963a9289DfbFfDF58125788Ae56A43',
  [ChainId.METIS]: '0x6957B8F72b9DcB6A05E1384E422454F107Ebe0a8',

}

export const METIDORIANS: ChainTokenMap = {
  [ChainId.MOONRIVER]: new Token(ChainId.MOONRIVER, METIDORIANS_ADDRESS[ChainId.MOONRIVER], 18, 'SOLAR', 'Solarbeam Token'),
  [ChainId.METIS]: new Token(ChainId.METIS, METIDORIANS_ADDRESS[ChainId.METIS], 18, 'METIDORIANS', 'Metidorians Token'),
}
