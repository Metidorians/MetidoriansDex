...
export const SUPPORTED_NETWORKS: {
  ...
  [ChainId.METIS]: {
    ...
    rpcUrls: ['https://andromeda.metis.io/?owner=1088','https://andromeda.metis.io/?owner=1088'],
  ...
  return (
    <Modal isOpen={networkModalOpen} onDismiss={toggleNetworkModal} maxWidth={672}>
      ...
      <div className="mb-6 text-lg text-primary">
        You are currently browsing <span className="font-bold text-blue">METIDORIANS</span>
