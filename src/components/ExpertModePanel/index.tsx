    ...
    return (
        <div className="">
            <div className="h-[34px] flex justify-end">
                <div className="bg-dark-800/20 rounded-tr rounded-tl-full gap-6 flex items-center -mb-2 relative justify-between pr-3 pl-8">
            ...
            <div className="border border-[2px] border-gray-800/20 rounded bg-dark-900">
                {children}
            </div>
        </div>
    )
