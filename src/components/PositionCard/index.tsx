  ...
  return (
    <>
      {userPoolBalance && JSBI.greaterThan(userPoolBalance.quotient, JSBI.BigInt(0)) ? (
        <div className="p-5 rounded bg-dark-purple/20 text-high-emphesis">
          <AutoColumn gap={'md'}>
            ...
            <div className="flex flex-col w-full p-3 mt-3 space-y-1 text-sm rounded bg-dark-900/20 text-high-emphesis">
              <RowBetween>
