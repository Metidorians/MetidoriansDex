    ...
    <Modal isOpen={isOpen} onDismiss={onDismiss} padding={28}>
      <div className=" h-60">
        ...
        <div className="flex items-baseline justify-center mt-3 text-3xl flex-nowrap">
          ...
          <p className="text-red">Transaction rejected.</p>
        </div>
        <div className="flex justify-center mt-5">
          <button
            onClick={onDismiss}
            className="flex items-center justify-center w-full h-12 text-lg font-medium rounded bg-red hover:bg-opacity-90 text-high-emphesis"
          >
            {i18n._(t`Dismiss`)}
          </button>
        </div>
