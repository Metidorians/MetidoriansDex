...
export default function DualChainCurrencyInputPanel({
  ...
  return (
    <>
      <div className={classNames('p-5 rounded rounded-b-none bg-dark-800/20')}>
        <div className="flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
            ...
            >
              <div className="flex">
                {currency ? (
                  ...
                  <div className="rounded bg-dark-700/20" style={{ maxWidth: 54, maxHeight: 54 }}>
          ...
          <div className={classNames('flex items-center w-full space-x-3 rounded bg-dark-900/20 focus:bg-dark-700 p-3')}>
            <>
      ...
      <div
        className={classNames(
          'flex items-center w-full  border-green-800 bg-dark-900/20 px-0 py-2 !mt-0 text-primary'
        )}
      >
