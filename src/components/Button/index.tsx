...
const FLEXED = {
  ...
  metidorians: 'bg-gradient-to-r from-green  to-black-800 w-full rounded text-high-emphesis hover:bg-opacity-100 disabled:bg-opacity-80',
  gradient:
...
const FILLED = {
  ...
  pink: 'bg-gradient-to-r from-opaque-pink to-opaque-purple-900 w-full rounded text-high-emphesis opacity-80 hover:opacity-100 disabled:bg-opacity-80',
  ...
  gradient:
    'w-full transition duration-1000 ease-in-out text-high-emphesis bg-gradient-to-r from-light-purple via-dark-purple to-red opacity-70 hover:opacity-100 disabled:bg-opacity-80',
  metidorians: 'bg-gradient-to-r from-green  to-black-800 w-full rounded text-high-emphesis hover:bg-opacity-100 disabled:bg-opacity-80',
}
...
const OUTLINED = {
  ...
  //light-green:'bg-transparent bg-opacity-20 border border-light-purple rounded text-light-purple hover:bg-opacity-40 disabled:bg-opacity-20',
  gradient:
...
export type ButtonColor = 'blue' | 'pink' | 'gradient' | 'gray' | 'default' | 'red' | 'green' | 'light-green' | 'metidorians'
...
export function ButtonError({
  ...
  if (error) {
    ...
    return <Button color={disabled ? 'pink' : 'gradient'} disabled={disabled} size="lg" {...rest} />
  }
}
