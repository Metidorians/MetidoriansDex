...
import { METIDORIANS } from '../../constants'
...
export function useUserInfo(farm, token) {
  ...
  const contract = useMetidoriansVaultContract()
...
export function usePositions() {
  return useSolarPositions(useMetidoriansVaultContract())
}
...
export function useVaults() {
  return useSolarVaults(useMetidoriansVaultContract())
}
...
export function useMetidoriansVaultInfo() {
  return useVaultInfo(useMetidoriansVaultContract())
}
