import {
  ...
  MULTICALL2_ADDRESS,
  RIB_MOVR_PAIR,
  METIDORIANS_METIS_PAIR,
  METIDORIANS_VAULT_ADDRESS,
  WNATIVE,
  ZAPPER_ADDRESS,
...
const UNI_FACTORY_ADDRESS = '0x88cB6bB88dfcE36EC7297C3AF7588aea3Eb59795'
...
export function useMetidoriansDistributorContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && SOLAR_DISTRIBUTOR_ADDRESS[chainId], SOLAR_DISTRIBUTOR_ABI, withSignerIfPossible)
}

export function useMetidoriansVaultContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && METIDORIANS_VAULT_ADDRESS[chainId], SOLAR_VAULT_ABI, withSignerIfPossible)
}
...
export function useMetidoriansMetisContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && METIDORIANS_METIS_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}
...
export function useDarkMatterContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && RIB_MOVR_PAIR[chainId], IUniswapV2PairABI, withSignerIfPossible)
}
...
export function useMetidoriansContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId && METIDORIANS_ADDRESS[chainId], IUniswapV2PairABI, withSignerIfPossible)
}
